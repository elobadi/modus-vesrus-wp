		...
		<div id="myCarousel" class="carousel slide" data-ride="carousel" data-interval="false">
			...
			<div class="carousel-inner">
				<div class="carousel-item active">
					<img class="d-block w-100" src="<?php bloginfo('stylesheet_directory'); ?>\img\img-1.jpeg" alt="First slide">
					<div class="carousel-caption d-none d-md-block">
						<h1 class="display-4">VESTIBULUM</h1>
						<p>Maecenas tincidunt, augue et rutrum condimentum, libero lectus mattis orci, ut commodo.</p>
					</div>
				</div>
				<div class="carousel-item">
					<img class="d-block w-100" src="<?php bloginfo('stylesheet_directory'); ?>\img\img-2.jpeg" alt="Second slide">
					<div class="carousel-caption d-none d-md-block">
						<h1 class="display-4">VESTIBULUM</h1>
						<p class="lead">Maecenas tincidunt, augue et rutrum condimentum, libero lectus mattis orci, ut commodo.</p>
					</div>
				</div>
				<div class="carousel-item">
					<img class="d-block w-100" src="<?php bloginfo('stylesheet_directory'); ?>\img\img-3.jpeg" alt="Third slide">
					<div class="carousel-caption d-none d-md-block">
						<h1 class="display-4">VESTIBULUM</h1>
						<p>Maecenas tincidunt, augue et rutrum condimentum, libero lectus mattis orci, ut commodo.</p>
					</div>
		...
		<div class="container mt-5">
			<div class="row">
				...
				<div class="col-xl-2 col-lg-3 text-center text-lg-right p-lg-0">
					<a role="button" href="services.html" class="btn btn-lg mt-3">VIEW MORE</a>
				</div>
			</div>
		</div>
	</section>
				...
				<div class="col-lg-3 col-md-6 mb-5 mb-lg-0">
					<div class="card active">
						<div class="card-body text-center">
							...
							<h5 class="card-title">SUSPENDISSE</h5>
							<p class="card-text">Quisque id tellus quis risus vehicula vehicula ut turpis. In eros nulla, placerat vitae at, vehicula ut nunc.</p>
							<a role="button" href="services.html" class="btn btn-lg">read more</a>
						</div>
					</div>
				</div>
				<div class="col-lg-3 col-md-6 mb-5 mb-lg-0">
					<div class="card">
						<div class="card-body text-center">
							<i class="fa fa-key"></i>
							<h5 class="card-title">MAECENAS</h5>
							<p class="card-text">Ut eleifend libero sed neque rhoncus consequat. Maecenas tincidunt, augue et rutrum condimentum, libero lectus mattis orci, ut commodo.</p>
							<a role="button" href="services.html" class="btn btn-lg">read more</a>
						</div>
					</div>
				</div>
				<div class="col-lg-3 col-md-6 mb-5 mb-lg-0">
					<div class="card">
						<div class="card-body text-center">
							...
							<h5 class="card-title">ALIQUAM</h5>
							<p class="card-text">Vivamus eget ante bibendum arcu vehicula ultricies. Integer venenatis mattis nisl, vitae pulvinar dui tempor non. </p>
							<a role="button" href="services.html" class="btn btn-lg">read more</a>
						</div>
					</div>
				</div>
				<div class="col-lg-3 col-md-6 mb-5 mb-lg-0">
					<div class="card">
						<div class="card-body text-center">
							...
							<h5 class="card-title">HABITASSE</h5>
							<p class="card-text">Astehicula ultricies. Integer venenatis mattis nisl, vitae pulvinar dui tempor non.</p>
							<a role="button" href="services.html" class="btn btn-lg">read more</a>
						</div>
					</div>
				</div>
				...
				<div class="carousel-inner">
						...
						<div class="card-deck text-center">
							...
							<div class="card big-img">
								<a href="https://www.getbootstrap.com">
									<img class="card-img-top" src="<?php bloginfo('stylesheet_directory'); ?>\img\clients-logos\bootstrap-logo.png" alt="Card image cap">
								</a>
							</div>
							<!-- .card -->
							...
							<div class="card big-img">
								<a href="https://www.jquery.com">
									<img class="card-img-top" src="<?php bloginfo('stylesheet_directory'); ?>\img\clients-logos\jquery-logo.png" alt="Card image cap">
								</a>
							</div>
							<!-- .card -->
							...
							<div class="card big-img">
								<a href="https://www.sass-lang.com">
									<img class="card-img-top" src="<?php bloginfo('stylesheet_directory'); ?>\img\clients-logos\sass-logo.png" alt="Card image cap">
								</a>
							</div>
							<!-- .card -->
							...
							<div class="card big-img">
								<a href="https://www.npmjs.com">
									<img class="card-img-top" src="<?php bloginfo('stylesheet_directory'); ?>\img\clients-logos\npm-logo.png" alt="Card image cap">
								</a>
							</div>
							<!-- .card -->
							...
							<div class="card big-img">
								<a href="https://www.git-scm.com">
									<img class="card-img-top" src="<?php bloginfo('stylesheet_directory'); ?>\img\clients-logos\git-logo.png" alt="Card image cap">
								</a>
							</div>
							<!-- .card -->
							...
							<div class="card big-img">
								<a href="https://www.github.com">
									<img class="card-img-top" src="<?php bloginfo('stylesheet_directory'); ?>\img\clients-logos\github-logo.png" alt="Card image cap">
								</a>
							</div>
							<!-- .card -->
					...
					<div class="carousel-item">
						<div class="card-deck text-center">
							...
							<div class="card big-img">
								<a href="#">
									<img class="card-img-top" src="<?php bloginfo('stylesheet_directory'); ?>\img\clients-logos\client-brand.png" alt="Card image cap">
								</a>
							</div>
							<!-- .card -->
